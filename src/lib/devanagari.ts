...
const KRUTI_COMMON_WORDS = new Set([
  "esa", "gSa", "gS", "gq,", "vkSj", "dks", "osQ", "dk", "dh", "fd",
  "Fkk", "Fks", "Fkha", "fd;k", "tk", "jgs", "jgh", "jgk", "gksrh", "gksrk",
  "gksrs", ",d", "bl", "us", "ij", "ls", "dksbZ", "buesa", "mlus", "tks",
  "mlosQ", "fp=k", "Lora=krk", "izfrek", "vè;k;", "vkfn", "fn;k", "fy,",
  "djsa", "djuk", "gks", "ugha", "viuk", "vius", "viuh", "dgrs", "dgk",
  "gksxk", "gksxh", "gksaxs", "Fkh", "Fks", "crk;k", "tkrk", "tkrh", "tkrs",
  "yksx", "yksxksa", "Hkh", "vki", "og", "os", ";g", ";s", "rqe", "ge",
  "lHkh", "lkFk", "ckn", "igys", "nwljk", "nwljs", "dksbZ", "dqN", "lc",
  "O;oLFkk", "lÙkk", "çdkj", "ns[ksa", "fn[kk,", "diM+ksa", "jk"
]);
...
export function convertKrutiDevToUnicode(legacyText: string): string {
  ...
  const fullConsonants = "(?:k=|k\\{|\\?k|Fk|\\/k|Hk|\'k|\\.k|\\[k|d|x|N|p|t|V|B|M|<|\\.|r|n|u|Q|i|c|e|;|y|j|o|\"|l|g|K|J)";
  const halfConsonants = "(?:D|X|\\?|P|T|>|R|F|\\/|U|¶|I|C|H|E|Y|O|\'|\"|L|G|\\[|\\{|\\=)";

  const fClusterRegex = new RegExp(
    `f((?:${halfConsonants})*${fullConsonants}[zª]?)`,
    "g"
  );
  ...
  const array_one: string[] = [
    ...
    "Fk", "?k", "/k", "Hk", "'k", ".k", "[k", "{k", "k=", "Vª", "Mª", "Bª", "<ª", ">\"",
    "D", "d", "X", "x", "N", "?", "³",
    "P", "p", "T", "t", "झ", "´",
    "V", "B", "M", "<", ".",
    "R", "r", "F", "n", "/", "U", "u",
    ...
    "K", "[", "{", "=", "J", "z",
    // Matras & modifiers
    "ks", "kS", "kW", "k", "h", "q", "w", "`", "s", "S", "a", "A", "%", "W", "~", "!", ":", "f", "Z"
  ];

  const array_two: string[] = [
    // Reph combinations
    "र्ा", "र्ं", "र्ै", "र्े", "र्ू", "र्ु", "र्ी", "र्ि",
    // Special ligatures
    "ह्र", "ह्न", "ह्म्", "ह्य", "ह्ल", "ह्व", "ह्",
    "‘", "’", "“", "”", "-", "•", "‰",
    "?", "।", "॥", "ऽ", "ॐ", "द्ग", "द्द", "द्ध", "द्भ", "द्म", "द्य", "द्व", "क्त", "ह्न", "ह्म्", "ह्य", "ह्ल", "ह्व", "हृ", "ष्ट", "ष्ठ", "ङ्क", "ङ्ख", "ङ्ग", "ङ्घ", "क्र", "द्र", "प्र", "श्र", "ट्र", "ठ्र", "ड्र", "ढ्र",
    "्र", "्", "ा", "ी", "ु", "ू", "ृ", "े", "ै", "ो", "ौ", "ं", "ँ", "ः", "़", "ऽ", "्",
    "क्र", "द्र", "प्र", "श्र", "ट्र", "ठ्र", "ड्र", "ढ्र",
    "ँ", "दृ", "द्य", "द्व", "द्म", "द्ध", "ह्", "हृ", "ह्न", "्र", "्र", "त्त", "रू", "रु", "ू", "र्", "ऋ", "रू", "झ", "फ्", "श", "ष", "त्र", "ज्ञ", "अं", "१", "२", "३",
    // Vowels
    "औ", "ओ", "ऑ", "आ", "अ",
    "ई", "इ", "उ", "ऊ", "ऋ",
    // Nukta consonants
    "क़", "ग़", "ज़", "ज़", "ड़", "ढ़", "फ़", "़", "ऱ", "फ़",
    // Consonants & half consonants
    "थ", "घ", "ध", "भ", "श", "ण", "ख", "क्ष", "त्र", "ट्र", "ड्र", "ठ्र", "ढ्र", "झ्",
    "क्", "क", "ग्", "ग", "छ", "घ्", "ङ",
    "छ", "च", "ज्", "ज", "झ", "झ",
    "ट", "ठ", "ड", "ढ", "ण्",
    "थ्", "त", "थ्", "द", "ध्", "न्", "न",
    "फ्", "फ", "प्", "प", "ब्", "ब", "भ्", "म्", "म",
    "य", "ल्", "ल", "र", "व्", "व", "श्", "ष्", "स्", "स", "ग्", "ह",
    "ज्ञ", "ख्", "क्ष्", "त्र्", "श्र", "्र",
    // Matras & modifiers
    "ो", "ौ", "ॉ", "ा", "ी", "ु", "ू", "ृ", "े", "ै", "ं", "।", "ः", "ॅ", "्", "!", "ः", "ि", "र्"
  ];
  ...
  const rephFixRegex = new RegExp(
    `((?:${devConsonant}[${devHalant}]?)+${devMatras})र्`,
    "g"
  );
