 ...
 * OPFS-SQLite, see storage.ts) remains the source of truth for metadata, extracted
 * text, and AI results, and also caches the blob locally for fast offline reads.
 */
